...
const CACHE = 'adhd-guide-v40';
const ASSETS = ['./', './index.html', './ar.html', './he.html', './hu.html', './about-hu.html', './contact-hu.html', './privacy-hu.html', './manifest-hu.json', './hu-g1.jpg', './hu-g2.jpg', './hu-g3.jpg', './hu-g4.jpg', './hu-g5.jpg', './hu-g6.jpg', './hu-g7.jpg',  './how-to-study-with-adhd.html', './how-to-study-with-adhd-ar.html', './how-to-study-with-adhd-he.html', './manifest.json', './manifest-ar.json', './manifest-he.json', './icon-192.png', './icon-512.png', './config.js', './auth.js', './signup-nudge.js', './bookmarks.js', './brain.js', './reports.js', './save-limit.js', './reveal-fix.js', './lightbox.js', './cadence.js', './a11y.js', './click-track.js', './langmenu.js', './polish.css', './ads.js', './analytics.js'];
